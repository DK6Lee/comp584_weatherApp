...
namespace Aspapi.Controllers
{
    ...
    public class SeedController : ControllerBase
    {
        ...
        public SeedController(WorldCitiesContext db, IWebHostEnvironment environment, UserManager<WorldCitiesUser> userManager)
        {
            _db = db;
        ...
        public async Task<IActionResult> ImportUsersAsync()
        {
            ...
            (string name, string email) = ("user", "user2@email.com");
        ...
        public async Task<IActionResult> ImportCountriesAsync()
        {
            ...
            Dictionary<string, Country> countriesByName = _db.Countries.AsNoTracking()
            ...
            IEnumerable<WorldCitiesCsv>? records = csv.GetRecords<WorldCitiesCsv>().ToList();
